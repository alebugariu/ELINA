...
static inline int opt_matpos2(int i, int j) {
	if (j > i)
		return opt_matpos(j ^ 1, i ^ 1);
	else
		return opt_matpos(i, j);
}
...
static inline void opt_scalar_of_upper_bound(opt_oct_internal_t* pr,
		elina_scalar_t* r, double d, bool div2) {
	elina_scalar_reinit(r, ELINA_SCALAR_DOUBLE);
	if (!isfinite(d))
		elina_scalar_set_infty(r, 1);
	else {
		r->val.dbl = d;
		if (div2)
			pr->conv = 1;
...
static inline void opt_bound_of_scalar(opt_oct_internal_t* pr, double *r,
		elina_scalar_t* t, bool neg, bool mul2) {
	if (neg)
		elina_scalar_neg(t, t);
	if (!elina_double_set_scalar(r, t, GMP_RNDU))
		pr->conv = true;
	if (mul2) {
		*r = (*r) * 2;
		pr->conv = true;
...
static inline bool opt_bounds_of_coeff(opt_oct_internal_t* pr, double *minf,
		double *sup, elina_coeff_t c, bool mul2) {
...
static inline elina_lincons0_t opt_lincons_of_bound(opt_oct_internal_t* pr,
	...
	if (i == j) {
		...
		elina_scalar_set_int(e->p.linterm[0].coeff.val.scalar,
				(i & 1) ? -1 : 1);
		opt_scalar_of_upper_bound(pr, e->cst.val.scalar, d, true);
	} else {
		...
		elina_scalar_set_int(e->p.linterm[0].coeff.val.scalar,
				(j & 1) ? 1 : -1);
		elina_scalar_set_int(e->p.linterm[1].coeff.val.scalar,
				(i & 1) ? -1 : 1);
...
static inline void opt_interval_of_bounds(opt_oct_internal_t* pr,
		elina_interval_t* i, double minf, double sup, bool div2) {
	opt_scalar_of_upper_bound(pr, i->sup, sup, div2);
	opt_scalar_of_lower_bound(pr, i->inf, minf, div2);
}

static inline void opt_oct_of_scalar(opt_oct_internal_t* pr, double * r,
		elina_scalar_t* t, bool neg, bool mul2) {
	if (neg)
		elina_scalar_neg(t, t);
...
static inline bool opt_oct_of_interval(opt_oct_internal_t* pr,
		opt_oct_mat_t *oo, unsigned short int i, elina_interval_t* itv,
		bool mul2) {
	double * m = oo->mat;
...
opt_oct_t* opt_oct_set_mat(opt_oct_internal_t* pr, opt_oct_t* o,
		opt_oct_mat_t* m, opt_oct_mat_t* closed, bool destructive);
...
opt_oct_t* opt_oct_closure(elina_manager_t *man, bool destructive,
		opt_oct_t *o);
...
opt_oct_t* opt_oct_meet(elina_manager_t* man, bool destructive, opt_oct_t* o1,
		opt_oct_t* o2);
opt_oct_t* opt_oct_join(elina_manager_t* man, bool destructive, opt_oct_t* o1,
		opt_oct_t* o2);
opt_oct_t* opt_oct_widening(elina_manager_t* man, opt_oct_t* o1, opt_oct_t* o2);
opt_oct_t* opt_oct_widening_thresholds(elina_manager_t* man, opt_oct_t* o1,
		opt_oct_t* o2, elina_scalar_t** array, size_t nb);
opt_oct_t* opt_oct_narrowing(elina_manager_t* man, opt_oct_t* o1,
		opt_oct_t* o2);
opt_oct_t* opt_oct_add_epsilon(elina_manager_t* man, opt_oct_t* o,
		elina_scalar_t* epsilon);
opt_oct_t* opt_oct_add_epsilon_bin(elina_manager_t* man, opt_oct_t* o1,
		opt_oct_t* o2, elina_scalar_t* epsilon);
opt_oct_t* opt_oct_join_array(elina_manager_t* man, opt_oct_t** tab,
		size_t size);
opt_oct_t* opt_oct_meet_array(elina_manager_t* man, opt_oct_t** tab,
		size_t size);
...
elina_interval_t* opt_oct_bound_texpr(elina_manager_t* man, opt_oct_t* o,
		elina_texpr0_t* expr);
elina_interval_t* opt_oct_bound_dimension(elina_manager_t* man, opt_oct_t* o,
		elina_dim_t dim);
elina_lincons0_array_t opt_oct_to_lincons_array(elina_manager_t* man,
		opt_oct_t* o);
bool opt_oct_sat_interval(elina_manager_t* man, opt_oct_t* o, elina_dim_t dim,
		elina_interval_t* i);
...
opt_oct_t* opt_oct_forget_array(elina_manager_t* man, bool destructive,
		opt_oct_t* o, elina_dim_t* tdim, int size, bool project);
opt_oct_t* opt_oct_add_dimensions(elina_manager_t* man, bool destructive,
		opt_oct_t* o, elina_dimchange_t* dimchange, bool project);
opt_oct_t* opt_oct_remove_dimensions(elina_manager_t* man, bool destructive,
		opt_oct_t* o, elina_dimchange_t* dimchange);
opt_oct_t* opt_oct_permute_dimensions(elina_manager_t* man, bool destructive,
		opt_oct_t* o, elina_dimperm_t* permutation);
...
opt_oct_t* opt_oct_meet_tcons_array(elina_manager_t* man, bool destructive,
		opt_oct_t* o, elina_tcons0_array_t* array);
opt_oct_t* opt_oct_assign_linexpr_array(elina_manager_t* man, bool destructive,
		opt_oct_t* o, elina_dim_t* tdim, elina_linexpr0_t** texpr, size_t size,
		opt_oct_t* dest);
opt_oct_t* opt_oct_assign_texpr_array(elina_manager_t* man, bool destructive,
		opt_oct_t* o, elina_dim_t* tdim, elina_texpr0_t** texpr, int size,
		opt_oct_t* dest);
