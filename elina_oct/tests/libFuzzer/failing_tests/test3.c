...
int main(int argc, char **argv) {
	...
	octagon2 = assign(dim, man, octagon2, assignment_values, 0);
	octagon2 = assign(dim, man, octagon2, assignment_values, 1);
	octagon2 = assign(dim, man, octagon2, assignment_values, 0);
	...
	octagon3 = assign(dim, man, octagon3, assignment_values, 1);
	octagon3 = assign(dim, man, octagon3, assignment_values, 0);
	octagon3 = assign(dim, man, octagon3, assignment_values, 1);
	octagon3 = assign(dim, man, octagon3, assignment_values, 0);
	octagon3 = assign(dim, man, octagon3, assignment_values, 0);
