...
int main(int argc, char **argv) {
	...
	long assignment_values[4] = { 0, 242, 0, -1 };
	octagon1 = assign(dim, man, octagon1, assignment_values, 0);
	long assignment_values1[4] = { -1, 0, 0, 0 };
	octagon1 = assign(dim, man, octagon1, assignment_values1, 0);
	...
	long assignment_values2[5] = { 0, 1, 39, -1 };
	octagon2 = assign(dim, man, octagon2, assignment_values2, 0);
	long assignment_values3[5] = { -1, 0, 0, 0 };
	...
	if (opt_oct_is_leq(man, octagon1, octagon2)
		...
		// x<=y && y<=z => x == y
		printf("octagon1 == octagon2: ");
		printf("%d\n", opt_oct_is_eq(man, octagon1, octagon2));
		fflush(stdout);
	}
	return 0;
}
