 ...
 ******/
void strengthening_comp_list(opt_oct_mat_t *oo, comp_list_t *cd,
...
bool strengthning_int_comp_sparse(opt_oct_mat_t * oo, unsigned short int * ind1,
		double *temp, int n) {
	double *m = oo->mat;
	array_comp_list_t *acl = oo->acl;
	int count = oo->nni;
...
bool strengthning_comp_sparse(opt_oct_mat_t *oo, unsigned short int * ind1,
		double *temp, int n) {
	double *m = oo->mat;
	array_comp_list_t *acl = oo->acl;
	int s = 0;
	int count = oo->nni;
	unsigned short int *cm = (unsigned short int *) calloc(n / 2,
 ...
 ******/
void compute_index_comp_sparse(double *m, unsigned short int *ca,
		unsigned short int comp_size, unsigned short int *index1,
		unsigned short int *index2, unsigned short int k, int dim) {
	int n = 2 * dim;
	index1[0] = 0;
	index1[n + 1] = 0;
	index2[0] = 0;
...
bool strong_closure_comp_sparse(opt_oct_mat_t *oo, double *temp1, double *temp2,
		unsigned short int *index1, unsigned short int *index2, int dim,
		bool is_int) {
	double *m = oo->mat;
	array_comp_list_t *acl = oo->acl;
	int count = oo->nni;
	...
	for (int l = 0; l < num_comp; l++) {
		...
		for (int k = 0; k < comp_size; k++) {
			 ...
			 *******/
			compute_index_comp_sparse(m, ca, comp_size, index1, index2, k1,
					dim);
